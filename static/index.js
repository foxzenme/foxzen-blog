...
(function () {
  ...
  const HOMEPAGE_I18N_STRINGS = {
    zh: {
      ...
      entry_update_name: "网站状态与公告（规划中，尚未上线）",
      entry_update_desc: "用于发布维护、故障、恢复等系统级公告（不是文章更新记录），暂未正式部署。",
      entry_github_name: "GitHub 静态镜像（规划中，尚未上线）",
      entry_github_desc: "基于 GitHub Pages 的独立静态文章镜像，不依赖 VPS，暂未正式部署。",
      entry_cf_name: "Cloudflare 静态镜像（规划中，尚未上线）",
      entry_cf_desc: "基于 Cloudflare Pages 的第二个独立静态发布入口，暂未正式部署。",
    ...
    en: {
      ...
      entry_update_name: "Site status & announcements (planned, not yet live)",
      entry_update_desc: "For publishing system-level announcements like maintenance, incidents, and recovery (not article update logs); not yet formally deployed.",
      entry_github_name: "GitHub static mirror (planned, not yet live)",
      entry_github_desc: "An independent static article mirror based on GitHub Pages, not dependent on the VPS; not yet formally deployed.",
      entry_cf_name: "Cloudflare static mirror (planned, not yet live)",
      entry_cf_desc: "A second independent static publishing entry based on Cloudflare Pages; not yet formally deployed.",
